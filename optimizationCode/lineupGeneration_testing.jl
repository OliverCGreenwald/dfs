...
#TESTING PATH
path_offensive_players = "data_warehouse/2016_cleaned_input/wk6/offensive_players.csv"
#PRODUCTION PATH
...
#TESTING PATH
path_to_output = "../resultsAnalysis/data_warehouse/testing_lineups/week6_dfn"
#PRODUCTION PATH
...
function one_lineup_no_stacking(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
...
function one_lineup_Type_1(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
function one_lineup_Type_2(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
# - QB-WR Stack (If you have a QB then also include a WR from the same team)
# - QB-oppWR
function one_lineup_Type_3(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
# - QB-WR Stack (If you have a QB then also include a WR from the same team)
# - no TE for flex
function one_lineup_Type_4(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
function one_lineup_Type_5(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
function one_lineup_Type_6(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack)
    #m = Model(solver=GLPKSolverMIP())
    m = Model(solver=GurobiSolver())
...
# for i=1:9
#     create_lineups(num_lineups, num_overlap, 0.1*i, path_offensive_players, path_defenses, formulation, string(path_to_output, "_formulation4_overlap_", num_overlap, "_exposure_0.", i, ".csv"))
# end
