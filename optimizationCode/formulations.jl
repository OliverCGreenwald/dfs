...
one_lineup_Type_4, one_lineup_Type_5, one_lineup_Type_6, one_lineup_Type_7, one_lineup_Type_8, one_lineup_Type_9
...
#   - WR must be #1 in terms of Targets Rank 
# - no TE for flex
# - Must have a Value RB (RB worth less than 5000)
function one_lineup_Type_9(offensive_players, defenses, lineups, num_overlap, num_offensive_players, num_defenses, quarterBack, runningBack, wideReciever, tightEnd, num_teams, offensive_players_teams, defenses_opponents, team_pairs, num_pairs, exposure, team_pairs_QBoppWR, num_pairs_QBoppWR, cheapRunningBack, num_lineups, projections_source, team_pairs_RBWR, num_pairs_RBWR, team_pairs_targets, num_pairs_targets)
    ...
    @addConstraint(m, constr[i=1:num_pairs_targets], 10*targets_stack[i] == sum{team_pairs_targets[k,i]*offensive_players_lineup[k], k=1:num_offensive_players})
