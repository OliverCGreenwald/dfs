...
####### Description #######
# Creates cleaned_input_files for Julia code for a given date and contest. Includes Rotogrinders,
# DFN, BaseballMonster, FantasyPros, and RotoWire projections.
# TODO:
...
####### Create Julia Input Files (Hitters and Pitchers) #######
create_julia_inputs <- function(contest.date, contest.name) {
  ####### Import Functions #######
  source("MLB/projectionsAnalysis/functions/clean_player_names.R")
