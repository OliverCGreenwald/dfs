---
title: "Lineups Report: Baseline Contests (2017-04-16 to 2017-05-24)"
...
ind_start <- which(baseline_contests$Date == "2017-04-16")
ind_end <- which(baseline_contests$Date == "2017-05-24")
