...
####### LOAD MODEL #######
all.wks <- 16:7
all.models <- c("svmlight_linear_costfactor0.08_wks4-15_minfpts18.5.RData",
                "svmlight_linear_costfactor0.075_wks4-14_minfpts18.5.RData",
                "svmlight_linear_costfactor0.08_wks4-13_minfpts18.5.RData",
                "svmlight_linear_costfactor0.075_wks4-12_minfpts18.5.RData",
                "svmlight_linear_costfactor0.01_wks4-11_minfpts18.5.RData",
                "svmlight_linear_costfactor0.06_wks4-10_minfpts18.5.RData",
                "svmlight_linear_costfactor0.065_wks4-9_minfpts18.5.RData",
                "svmlight_linear_costfactor0.075_wks4-8_minfpts18.5.RData",
                "svmlight_linear_costfactor0.1_wks4-7_minfpts18.5.RData",
                "svmlight_linear_costfactor0.07_wks4-6_minfpts18.5.RData")
models.dat <- as.data.frame(as.matrix(cbind(all.wks, all.models)))
models.dat$all.wks <- as.numeric(as.character(models.dat$all.wks))
models.dat$all.models <- as.character(models.dat$all.models)

for (w in 1:nrow(models.dat)) {
  save.model.name <- models.dat$all.models[w]
  ...
  ownership.bool <- F # set to TRUE if want to apply Value WR spiking procedure on ownership adjusted projections
  
  
  ####### PARAMETERS #######
  wk <- models.dat$all.wks[w]
